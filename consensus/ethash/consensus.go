...
var (
	...
	ByzantiumBlockReward          = big.NewInt(9e+18) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(9e+18) // Block reward in wei for successfully mining a block upward from Constantinople
